...
ddmd: ddmd.exe
ddmd.exe: $(DC) $(DSRC) glue.lib backend.lib outbuffer.obj aav.obj stringtable.obj
	$(DC) $(DSRC) -ofddmd.exe glue.lib backend.lib outbuffer.obj aav.obj stringtable.obj -debug -vtls -J.. -d -version=DMDV2 -L/STACK:8388608 -g -map
